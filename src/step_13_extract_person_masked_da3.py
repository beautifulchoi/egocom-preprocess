...
This extractor mirrors src/step_12_extract_person_masked_clip.py at the data/output level,
...
from step_12_extract_person_masked_clip import FrameMask, collect_frame_masks
