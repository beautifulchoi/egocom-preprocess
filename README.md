...
| 1 | DA3 depth and intrinsics | Used by [Depth-Based Mask Refinement](https://htmlpreview.github.io/?https://github.com/beautifulchoi/egocom-preprocess/blob/main/filter_mask_explanation.html) and [Person Depth Lift](https://htmlpreview.github.io/?https://github.com/beautifulchoi/egocom-preprocess/blob/main/person_depth_lift_explanation.html) | `extract_depth.py` | `{split}/da3/monocular`, `{split}/da3/nested` |
| 2 | SAM3 person masks | Input to [Depth-Based Mask Refinement](https://htmlpreview.github.io/?https://github.com/beautifulchoi/egocom-preprocess/blob/main/filter_mask_explanation.html) | `extract_mask.py` | `{split}/person_mask/{video}` |
| 3 | Depth-filter masks | [Depth-Based Mask Refinement](https://htmlpreview.github.io/?https://github.com/beautifulchoi/egocom-preprocess/blob/main/filter_mask_explanation.html) | `filter_mask.py` | `{split}/refined_mask/{video}` |
| 4 | Extract face embeddings | [Person Face Embedding Extraction](https://htmlpreview.github.io/?https://github.com/beautifulchoi/egocom-preprocess/blob/main/extract_person_embeding_explanation.html) | `extract_person_embeding.py` | Per-video face embedding outputs from refined masks |
| 5 | Map segment IDs to scene person IDs | [Face-Embedding Person Mapping](https://htmlpreview.github.io/?https://github.com/beautifulchoi/egocom-preprocess/blob/main/map_person_face_embedding_explanation.html) | `map_person_face_embedding.py` | `{split}/person_face_mapping/{scene}` |
| 6 | Inspect mapping outputs | [Person Mapping Outputs Guide](https://htmlpreview.github.io/?https://github.com/beautifulchoi/egocom-preprocess/blob/main/person_face_report_outputs_guide.html), [Current Mapping Report](https://htmlpreview.github.io/?https://github.com/beautifulchoi/egocom-preprocess/blob/main/person_face_mapping_report.html) | `report_person_face_mapping.py` | Mapping report HTML/JSON summaries |
| 7 | Remap all chunks from selected prototypes | [All-Chunk Person Remapping](https://htmlpreview.github.io/?https://github.com/beautifulchoi/egocom-preprocess/blob/main/remap_person_face_all_chunks_explanation.html) | `remap_person_face_all_chunks.py` | `remap_all_chunks.json`, remap summaries |
